           ...
           <CardContent className="space-y-4">
             <div className="p-4 rounded-lg bg-accent/50 border border-accent">
               <div className="flex items-start gap-3">
                 ...
                 <div className="space-y-2">
                   <h4 className="font-medium">Service Account Setup</h4>
                   <p className="text-sm text-muted-foreground">
                     To enable Google Drive uploads, you need to set the <code className="px-1.5 py-0.5 rounded bg-muted text-sm">GOOGLE_SERVICE_ACCOUNT_JSON</code> environment variable with your service account credentials.
                   </p>
                   <ol className="text-sm text-muted-foreground list-decimal list-inside space-y-1">
                     <li>Go to Google Cloud Console and create a service account</li>
                     <li>Download the JSON key file</li>
                     <li>Set the JSON content as an environment variable</li>
                   </ol>
